...
SELECT 
    CustomersID AS 'ID',
    CustomersName AS 'Nome do Cliente',
    ContactName AS 'Nome de Contato', -- Corrigido "Contado" para "Contato"
    Address AS 'Endereco', 
    City AS 'Cidade',
...
ORDER BY City, CustomersName ASC
LIMIT 0, 400;
/*drop database sisrafael*/
